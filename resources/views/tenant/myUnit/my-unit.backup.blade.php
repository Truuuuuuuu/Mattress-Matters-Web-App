        ...
        @if($myUnit?->reservation?->status === 'checked_in')
            <div class="drawer lg:drawer-open" x-data="{ activeSection: 'overview' }">
                ...
                <div class="drawer-side is-drawer-close:overflow-visible">
                    ...
                    <div
                        class="flex pt-15 min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                        <!-- Sidebar content here -->
                        <ul class="menu w-full grow">
                            <!-- List item -->
                            <li>
                                <button class="is-drawer-close:tooltip is-drawer-close:tooltip-right"
                                        data-tip="Overview" :class="{ 'active': activeSection === 'overview' }"
                            ...
                            <li>
                                <button class="is-drawer-close:tooltip is-drawer-close:tooltip-right"
                                        data-tip="Payments" :class="{ 'active': activeSection === 'payments' }"
                            ...
                            <li>
                                <button class="is-drawer-close:tooltip is-drawer-close:tooltip-right"
                                        data-tip="Rules & Amenities" :class="{ 'active': activeSection === 'rules' }"
