...
<x-layout :hideNavbar="false" >
    ...
    <div class="h-screen flex items-center w-full bg-cover bg-center bg-no-repeat px-4 " style="background-image: url('{{ asset('images/login-bg.jpg') }}');">
        <div class="w-full md:max-w-md mx-auto p-6 rounded-3xl
            bg-white/10 backdrop-blur-lg
            border border-white/20
            shadow-lg">
                <h2 class="text-center text-sm font-semibold text-base-content/70 ">Log in or sign up</h2>
                <h1 class="font-semibold text-xl text-center">Welcome to Mattress Matters</h1>
                ...
                <div class="flex flex-col gap-2 mt-5">
                    <!-- Google -->
                    <a href="{{route('social.redirect', 'google')}}" class="btn bg-white rounded-3xl ">
