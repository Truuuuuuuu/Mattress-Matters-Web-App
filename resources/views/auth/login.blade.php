    ...
    <div class="grid lg:grid-cols-2 max-w-full h-screen ">
        ...
        <div class="flex items-center justify-center text-base-content">
            <div class="w-full lg:max-w-md mx-auto px-6">
                ...
                <x-divider class="bg-gray-300 my-3"></x-divider>
                <h1 class="font-semibold text-xl ">Welcome to Mattress Matters</h1>
                ...
                <div class="flex flex-col gap-2 mt-5">
                    <!-- Google -->
                    <a href="{{route('social.redirect', 'google')}}" class="btn bg-white text-black border-black rounded-xl hover:bg-gray-100">
                    ...
                    <!-- Facebook -->
                    <a href="{{route('social.redirect', 'facebook')}}" class="btn bg-white border border-black rounded-xl text-gray-700 hover:bg-gray-100 gap-2">
                        <svg
