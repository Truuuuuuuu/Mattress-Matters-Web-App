    ...
    @if (!isset($hideNavbar))
        <nav class=" sticky top-0 z-50 bg-base-100 shadow flex justify-between items-center py-4 border-b border-white/10 p-5">
                ...
                @auth
                    ...
                    {{-- links --}}
                    <div class="hidden lg:flex text-base-content  gap-8 items-center whitespace-nowrap font-semibold ">
                        <a href="">Explore</a>
                        <a href="">My Unit</a>
                    ...
                    @role('host')
                    {{-- links --}}
                    <div class="hidden lg:flex text-base-content  gap-10 font-semibold">
                ...
                @auth
                        <div class="flex space-x-3 font-bold ">
                            <div class="flex btn btn-ghost btn-circle text-white lg:bg-gray-200 lg:text-black" tabindex="0" role="button">
