...
<x-forms.form action="/listings" method="GET">
    <div class="relative -mt-1">
        <x-forms.input :label="false" name="search" placeholder="Search here..." class="rounded-4xl input input-primary input-lg text-sm pr-12 w-full" value="{{request('search')}}"> </x-forms.input>
