<x-layout>
    ...
    <div class="w-full max-w-[1440px] mx-auto px-5 py-7 bg-primary/[4%] min-h-[calc(100vh-5rem)]"
        ...
        <x-tabs :tabs="['active', 'moving out', 'billing', 'history']" default="active" :showViewToggle="true" title="My Tenants">
        ...
        <div x-show="open"
             ...
             class="fixed z-50 hidden md:block
                    ...
                    w-full max-w-2xl lg:max-w-3xl max-h-[90vh] overflow-y-auto
            ...
            <div class="flex items-center justify-between p-5 border-b border-base-300 sticky top-0 bg-base-100 z-10">
                <h3 class="font-semibold text-lg text-primary">Tenant Information</h3>
